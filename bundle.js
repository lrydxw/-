...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={
		loadLoginHeader:function(type,img,goodsName,price,discount){
		...
		loadLoginContent:function(type,img,goodsName,price,discount){
			...
			$("section").load("html/order.html #ordercontent",function(){
				if(localStorage.getItem("userID")){	
					...
					for(var i=0;i<len;i++){
						...
						var newprice=(price*discount/10).toFixed(2);
